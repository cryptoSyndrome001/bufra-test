...
const Signup: FC = () => {
    return (
        <>
            <div className="signup-main-dark">
                    ...
                    <div className="sign-up">
                        <div className="nav-bar">
                            ...
                            <div className="button-otr">
                                <a href="" className="member body-sb">Already a member?</a>
                                <div className="action-otr">
                                    <Link to="/login" className="btn-fill-white btn-signup">Login</Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-lg-6 col-login-otr">
                                <div className="col-login-inr">
                                    <div className="content">
                                        ...
                                        <div className="login-social">
                                            <span className="line"/>
                                            <p className="desc body-s">Or sign up with email</p>
                                            <span className="line"/>
                                        </div>
                                        <form className="form-main" method="post">
                                            ...
                                            <div className="input-otr input-otr-2">
                                                <input className="input" type="password" name="pwd"
                                            ...
                                            <div className="check-main">
                                                <div className="check">
                                                    ...
                                                    <span className="check-inner">
                                                        ...
                                                        <span className="select-none body-sb">I agree to the <Link to="/privacy-policy" className="link body-sb"> Privacy Policy </Link> &
                                                            <Link
                                                            to="/terms-of-service"
                                                            className="link body-sb"> Terms of Service </Link></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div className="action-otr">
                                                <input className="button body-sb" type="submit" value="Sign Up"/>
                                            </div>
                                        </form>
                                    </div>
                                </div>
